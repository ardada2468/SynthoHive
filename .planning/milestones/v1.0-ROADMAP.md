...
- [x] 01-05-PLAN.md — Gap closure: raise ConstraintViolationError on enforce_constraints=True violations; replace three silent except blocks with logged warnings; add constraint violation test
